/**
 * @file use-annual-contract-hours.test.ts
 * @description Tests para el hook useAnnualContractHours
 */

import { describe, it, expect, beforeEach } from '@jest/globals';
import { renderHook, act } from '@testing-library/react';
import { useAnnualContractHours } from '../use-annual-contract-hours';
import {
  ANNUAL_CONTRACT_HOURS_CONSTRAINTS,
  WarningType,
} from '@/src/core/domain/annual-contract-hours';
...
describe('useAnnualContractHours', () => {
  ...
  describe('useWeeklyCalculation', () => {
    it('calcula las horas anuales desde las semanales', () => {
      ...
      act(() => {
        result.current.useWeeklyCalculation();
      });
