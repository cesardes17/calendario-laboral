...
import { EmploymentStatus } from '@/src/core/domain/employment-status';
import { ContractStartDate } from '@/src/core/domain/contract-start-date';
import { CycleOffset } from '@/src/core/domain/cycle-offset';
import { WorkingHours } from '@/src/core/domain/working-hours';
import { AnnualContractHours } from '@/src/core/domain/annual-contract-hours';
...
} from '@/src/core/usecases/validate-configuration.usecase';
