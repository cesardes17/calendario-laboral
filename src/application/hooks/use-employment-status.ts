...
import {
  ...
  CycleOffsetInput,
  ValidationResult,
} from '@/src/core/usecases/select-employment-status.usecase';
import {
  EmploymentStatus,
  EmploymentStatusType,
} from '@/src/core/domain/employment-status';
import { ContractStartDate } from '@/src/core/domain/contract-start-date';
import { CycleOffset, CycleDayType } from '@/src/core/domain/cycle-offset';
