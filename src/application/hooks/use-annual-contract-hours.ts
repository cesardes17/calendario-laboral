/**
 * @file use-annual-contract-hours.ts
...
import {
  ...
  type ConfigureAnnualContractHoursInput,
} from '@/src/core/usecases';
import type { AnnualContractHours } from '@/src/core/domain';
import { ANNUAL_CONTRACT_HOURS_CONSTRAINTS } from '@/src/core/domain/annual-contract-hours';
...
export function useAnnualContractHours(): UseAnnualContractHoursReturn {
   ...
   */
  const useWeeklyCalculation = useCallback(() => {
