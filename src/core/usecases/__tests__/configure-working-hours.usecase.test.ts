/**
 * @file configure-working-hours.usecase.test.ts
 * @description Tests para el caso de uso ConfigureWorkingHours
 */

import { describe, it, expect, beforeEach } from '@jest/globals';
import { ConfigureWorkingHoursUseCase } from '../configure-working-hours.usecase';
import { WorkingHours, DEFAULT_WORKING_HOURS } from '../../domain/working-hours';
