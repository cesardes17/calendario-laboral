/**
 * @file configureAnnualContractHours.usecase.test.ts
 * @description Tests para el caso de uso ConfigureAnnualContractHours
 */

import { describe, it, expect, beforeEach } from '@jest/globals';
import { ConfigureAnnualContractHoursUseCase } from '../configureAnnualContractHours.usecase';
import { ANNUAL_CONTRACT_HOURS_CONSTRAINTS } from '../../domain/annualContractHours';
