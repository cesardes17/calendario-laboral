...
import { SelectEmploymentStatusUseCase } from '../select-employment-status.usecase';
import { EmploymentStatusType } from '../../domain/employment-status';
import { CycleDayType } from '../../domain/cycle-offset';
